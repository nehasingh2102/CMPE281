...
<body>
 ...
 <?php
            ...
            $query = "INSERT INTO nodes (instkey,fromvalue,dbname) VALUES ('$key','$values', '$dbname')";
            ...
            if ( !( $result = mysqli_query($database,$query ) ) ) {
			  ...
			  echo "<strong> added successfully </strong> <br />";
?>
			  <a href="addform.php" class="btn btn-lg btn-dark">Add another node</a>
