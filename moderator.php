    ...
    <header id="top" class="header">
        <div class="text-vertical-center">
           <h1>                </h1>
            ...
            <h3>This is the moderator view.</h3>
            <br>
            <a href="test.php" class="btn btn-dark btn-lg">  Add Cluster  </a>
            <a href="moderator.php" class="btn btn-dark btn-lg">Delete Cluster</a>
        </div>
    </header>
