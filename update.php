...
<body>
    ...
    <?php
            ...
            $query = "UPDATE nodes SET `fromvalue`='$values',`dbname`='$dbname' WHERE `instkey`='$key'";
            ...
            if ( !( $result = mysqli_query($database,$query ) ) ) {
			  ...
			  print( "node updated! <br />" );
			 
			 ?>
			  <a href="updateform.php" class="btn btn-lg btn-dark">Update another node</a>
