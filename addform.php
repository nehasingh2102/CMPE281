           ...
           <h1>                </h1>
            ...
            <br>
                    	...
                    	<table border="0" cellpadding="0" cellspacing="0" align="center" width="200">
                    	 ...
                    	 <tr>
                    			<td colspan="3">Enter Node Name</td>
                    	</tr>
                    	 	<tr>
                    			<td colspan="3">
                    		...
                    		<tr>
                    			<td colspan="3">Enter Database Name</td>
                    		</tr>
                    		<tr>
                    			<td colspan="3">
                    		...
                    		<tr>
                    			<td colspan="3">
                    				<input type="submit" name="add" value="ADD" class="btn btn-lg btn-dark">
                    			</td>
