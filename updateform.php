           ...
           <h1>                </h1>
            ...
            <br>
                    	...
                    	<table border="0" cellpadding="0" cellspacing="0" align="center" width="200">
                    	 ...
                    	 <tr>
                    			<td colspan="3">Enter Node Name To Be Updated</td>
                    	</tr>
                    	 	<tr>
                    			<td colspan="3">
                    				<input size="50" name="key" style="color: #000000">
                    			</td>
                    		</tr>
                    		<tr>
                    			<td colspan="3">Update Values</td>
                    		</tr>
                    		<tr>
                    			<td colspan="3">
                    				<input type="text" style="color: #000000" size="50" name="values"/>
                    			</td>
                    		</tr>
                    		
                    		<tr>
                    			<td colspan="3">Update Database Name</td>
                    		</tr>
                    		<tr>
                    			<td colspan="3">
                    				<input type="text" style="color: #000000" size="50" name="dbname"/>
                    			</td>
                    		</tr>
                    		
                    		<tr>
                    			<td colspan="3">
                    				<input type="submit" name="add" value="UPDATE" class="btn btn-lg btn-dark">
                    			</td>
